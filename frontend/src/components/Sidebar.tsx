  ...
  return (
    <aside className="w-full md:w-80 bg-slate-950/80 border-b md:border-b-0 md:border-r border-slate-800/60 p-6 flex flex-col h-full backdrop-blur-xl">
      ...
      <div className="flex items-center gap-3 mb-8">
        <div className="p-2 bg-gradient-to-tr from-violet-600 to-indigo-600 rounded-xl shadow-lg shadow-indigo-500/20 animate-pulse">
          <Brain className="w-6 h-6 text-white" />
        </div>
        <div>
          <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-indigo-200 to-violet-300">
            WebMind
          </h1>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl font-semibold text-sm transition-all duration-300 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white shadow-lg shadow-indigo-500/10 hover:shadow-indigo-500/20 border border-violet-500/20 hover:scale-[1.02] active:scale-[0.98] mb-8"
      >
